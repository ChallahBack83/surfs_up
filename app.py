...
#create variable for each of classes to reference later
...
#define our app for Flassk app
app = Flask(__name__)

#create flask routes starting with "homepage"
@app.route('/')
...
def precipitation():
    ...
    #create date and key values with jsonify
